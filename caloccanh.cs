...
{
    public partial class caloccanh : Form
    {
        public caloccanh()
        {
            InitializeComponent();
        ...
        {
            String tenloaica = "lóc mắt bò";
            String gia = "150.000";
            String nguongoc = "Có nguồn gốc từ Ấn Độ, và được tìm thấy ở nhiều quốc gia khác như: Sri Lanka, Bangladesh, Nepal, Myanmar và Thái Lan đến miền nam Trung Quốc, Lào và Việt Nam";
